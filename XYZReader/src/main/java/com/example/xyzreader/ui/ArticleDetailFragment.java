...
public class ArticleDetailFragment extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mPhotoView = (ImageView) mRootView.findViewById(R.id.detail_header_photo);
    ...
    private void bindViews() {
        ...
        TextView bylineView = (TextView) mRootView.findViewById(R.id.toolbar_subtitle);
        ...
        if (mCursor != null) {
            ...
            // Explicitly setting visibility so it does not appear at the top while article is loading
